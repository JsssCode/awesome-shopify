...
- [SmallAwesomeShop](https://github.com/JsssCode/SmallAwesomeShop) - An Angular 7 App example using Shopify's Storefront GraphQL API and GraphQL-js-client. Could be usefull for Angular 2+ and Ionic developers.
